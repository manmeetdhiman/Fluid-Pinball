...
class Iteration():
    ...
    def run_iteration(self):
        ...
        for actions in range(num_actions):
            ...
            print(f'Getting action for iteration-{self.iteration_ID}-state-{state}: action = {action}')
    ...
    def run_action(self):
        ...
        # print(f'Motor_data-{self.iteration_ID}-{self.action_counter}: {mot_data}')
        vel_data = CFD.cfd.RL_run_CFD(iteration=self.iteration_ID, action=self.action_counter,
                                      ...
                                      motor_params=mot_data, submit_slurm=False)
...
def main():
    ...
    for policy in range(num_policies):
        ...
        total_rewards_filename = f'total_rewards_{policy+1}.pickle'
